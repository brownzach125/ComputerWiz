...
Match.matchLoop = function(match) {
    ...
    match.game.redWizard.matchUpdate(match.state);
    match.game.blueWizard.matchUpdate(match.state);
};

Match.prototype.playerPutKeyDown = function(wizardName, data) {
    this[wizardName].keyDown(data);
};

Match.prototype.playerPutKeyUp = function(wizardName, data) {
